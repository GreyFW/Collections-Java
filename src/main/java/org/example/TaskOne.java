...
public class TaskOne {
    ...
    public static void firstTaskArray(int n) {
        ...
        System.out.println("g) Оставили в списке только уникальные элементы:\n" + listA);
        ...
        System.out.println("g) Оставили в списке только дублирующиеся элементы:\n" + duplicatesOnly);
